...
import com.sing.internal.DrawableCompat;
...
public class MaterialProgressBar extends ProgressBar {
    ...
    private void fixCanvasScalingWhenHardwareAccelerated() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2) {
            // Canvas scaling when hardware accelerated results in artifacts on older API levels, so we need to use software rendering
    ...
    // Progress drawables in this library has already rewritten tint related methods for compatibility.
    @SuppressLint("NewApi")
